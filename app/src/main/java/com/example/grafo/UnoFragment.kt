...
import com.example.grafo.databinding.FragmentUnoBinding
...
class UnoFragment : Fragment() {
    ...
    var _enlace: FragmentUnoBinding?=null
    val enlace
        get()=_enlace!!
    ...
    override fun onCreateView(
        ...
        _enlace=FragmentUnoBinding.inflate(layoutInflater,container,false)
        return enlace.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        enlace.fondo1.setOnClickListener {
